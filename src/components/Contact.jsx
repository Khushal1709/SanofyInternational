...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Phone number validation for Indian format (starts with 6–9, 10 digits)
                ...
                <div className="flex flex-col gap-5 sm:gap-6">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="text-base sm:text-lg">Email Address:</span>
...
// Form validation without phone number validation 
// import { useState } from "react";
// import contact1 from "../image/contact1.svg";
// import email from "../image/email.svg";
// import phone from "../image/phone.svg";
